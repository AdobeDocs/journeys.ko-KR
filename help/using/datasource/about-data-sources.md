...
* 실시간 고객 프로필 서비스에 대한 연결을 정의하는 사전 구성된 Experience Platform 데이터 소스(기본 데이터 소스). [](../datasource/adobe-experience-platform-data-source.md)를 참조하십시오.
...
Experience Platform 데이터 소스 및 외부 데이터 소스를 구성하는 방법, 그리고 경로에서 데이터를 찾아서 사용하는 방법과 관련된 자세한 내용을 확인하려면 이 [튜토리얼 비디오](https://docs.adobe.com/content/help/en/platform-learn/tutorials/journey-orchestration/configure-data-sources.html)를 시청하십시오.
