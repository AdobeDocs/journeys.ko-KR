...
* Adobe Campaign Standard 트랜잭션 메시징의 스케일은 주어진 인스턴스에 대해 채널 간에 최대 시간당 50,000개의 메시지 수입니다. 자세한 내용은 [Adobe Campaign Standard 제품 설명](https://helpx.adobe.com/kr/legal/product-descriptions/campaign-standard.html). 
 
